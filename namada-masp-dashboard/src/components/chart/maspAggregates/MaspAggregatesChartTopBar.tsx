...
export default function MaspAggregatesChartTopBar({
  ...
  return (
    <div className="min-w-full min-h-[36px] flex justify-between items-end mb-4">
      <div className="flex items-center gap-4">
        {/* Asset Select */}
        <div className="flex flex-col gap-1">
          <div className="text-[11px] font-light tracking-[0.4px] text-white/90 pl-2">Select asset</div>
          <select 
            value={selectedAsset}
          ...
          >
            ...
            {assets.map(asset => (
              <option key={asset.symbol} value={asset.symbol} className="text-[14px] font-light">
                {asset.symbol}
              </option>
            ))}
          </select>
        ...
        {/* Time Select */}
        <div className="flex flex-col gap-1">
        <div className="text-[11px] font-light tracking-[0.4px] text-white/90 pl-2">Time</div>
